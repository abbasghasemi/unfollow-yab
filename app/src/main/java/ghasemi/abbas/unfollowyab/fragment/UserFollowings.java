...
public class UserFollowings extends BaseFragment {
    ...
    private void load() {
        ...
        isLoading = true;
        IgApi.instance().getUserFollowing(getArguments().getString("pk"), max_id, (status, jsonObject) -> {
